    ...
    <div className="min-h-screen bg-[#0b0e12] text-slate-100">
      ...
      <header className="relative overflow-hidden hero-grid">
        <div className="relative max-w-6xl mx-auto px-6 pt-10 pb-20 md:pt-14 md:pb-28">
          <nav className="flex items-center justify-between text-sm uppercase tracking-[0.3em] text-slate-400">
            ...
            <a
              href="#contact"
              className="hidden md:inline-flex px-4 py-2 rounded-full border border-slate-600/60 hover:border-slate-300 transition-colors"
            >
              Request kit guide
            </a>
          </nav>
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <a
                  ...
                  className="cta-button inline-flex items-center gap-2 rounded-full bg-white text-slate-900 px-6 py-3 text-sm font-semibold"
                >
